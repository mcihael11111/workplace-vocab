  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ width: 32, height: 32, borderRadius: 8, background: isDone ? "#22C55E" : hov ? cat.accent : "#F1F5F9", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.2s" }}>
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke={isDone || hov ? "#fff" : "#94A3B8"} strokeWidth="2.5">
